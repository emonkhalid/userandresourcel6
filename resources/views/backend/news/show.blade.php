          ...
          <div class="card shadow mb-4 ">
            <div class="card-header py-3">
              <div class="float-left">
                <h3 class="m-0 font-weight-bold text-primary">View News</h3>
             </div>
              <div class="float-right">
                  <a href="{{ route('user.create') }}" class="float-right btn btn-sm btn-primary">Create News</a>
              </div>
            </div>
            <div class="card-body">
              <div class="row">
           ...
           {{  Form::model($news, [
                ...
                <div class="form-group {{ $errors->has('name' ? 'has-error' : '') }}">
                  ...
                  <img class="img-fluid img-thumbnail" style="display:block;width:250px;height:250px;" src="{{ asset('backend/img/news_photos/'.$news->photo->photo_path) }}">
                  @else
            ...
            {!! Form::close() !!} 
                ...
                <a class="btn btn-primary" href="{{ route('news.index') }}">OK</a>
